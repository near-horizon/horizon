export function Server042Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        opacity="0.12"
        d="M3 2.5H21L22 10.5H21.9646C21.7219 8.80385 20.2632 7.5 18.5 7.5H5.5C3.73676 7.5 2.27806 8.80385 2.03544 10.5H2L3 2.5Z"
        fill="currentColor"
      />
      <path
