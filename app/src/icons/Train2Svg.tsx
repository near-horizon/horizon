export function Train2Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        opacity="0.4"
        d="M9.5 22H14.5M8 2H12M12 2H16M12 2V5"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
