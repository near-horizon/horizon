export function MarkerPin04Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        opacity="0.4"
        d="M5 14.2861C3.14864 15.1028 2 16.241 2 17.4998C2 19.9851 6.47715 21.9998 12 21.9998C17.5228 21.9998 22 19.9851 22 17.4998C22 16.241 20.8514 15.1028 19 14.2861"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
