export function HorizontalBarChart021Svg({
  className,
}: {
  className?: string;
}) {
  return (
    ...
    >
      <path
        opacity="0.12"
        d="M19.4 9.5C19.9601 9.5 20.2401 9.5 20.454 9.39101C20.6422 9.29513 20.7951 9.14215 20.891 8.95399C21 8.74008 21 8.46005 21 7.9V6.1C21 5.53995 21 5.25992 20.891 5.04601C20.7951 4.85785 20.6422 4.70487 20.454 4.60899C20.2401 4.5 19.9601 4.5 19.4 4.5L3 4.5L3 9.5L19.4 9.5Z"
        fill="currentColor"
      />
      <path
