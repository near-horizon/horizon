export function BookClosed3Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        opacity="0.4"
        d="M20 16H7C5.34315 16 4 17.3431 4 19"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
