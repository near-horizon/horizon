export function ChartBreakoutCircle1Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        opacity="0.12"
        d="M2 11.9999C2 17.5228 6.47715 21.9999 12 21.9999C17.1853 21.9999 21.4489 18.0533 21.9506 12.9999L11 2.04932C5.94668 2.55104 2 6.81459 2 11.9999Z"
        fill="currentColor"
      />
      <path
