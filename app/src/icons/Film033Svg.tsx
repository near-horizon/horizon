export function Film033Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        opacity="0.4"
        d="M7 2V6M7 16L7 20M17 4V8M17 18V22"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
