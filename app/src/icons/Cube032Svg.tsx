export function Cube032Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      />
      <path
        d="M17 20.2071C17 20.6526 17.5386 20.8756 17.8536 20.5607L21.4142 17C21.7893 16.6249 22 16.1162 22 15.5858L21.9979 4.62329C21.9979 4.17788 21.4593 3.95488 21.1444 4.26983L17.1464 8.26777C17.0527 8.36154 17 8.48871 17 8.62132V20.2071Z"
        fill="currentColor"
      />
    </svg>
  );
