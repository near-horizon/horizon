export function FaceHappy1Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16.5 14C16.5 15.667 14.5005 17.5 12 17.5C9.4995 17.5 7.5 15.667 7.5 14H16.5Z"
        fill="currentColor"
      />
      <path
