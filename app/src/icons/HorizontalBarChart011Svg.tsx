export function HorizontalBarChart011Svg({
  className,
}: {
  className?: string;
}) {
  return (
    ...
    >
      <path
        opacity="0.12"
        d="M19.4 14.5C19.9601 14.5 20.2401 14.5 20.454 14.391C20.6422 14.2951 20.7951 14.1422 20.891 13.954C21 13.7401 21 13.4601 21 12.9V11.1C21 10.5399 21 10.2599 20.891 10.046C20.7951 9.85785 20.6422 9.70487 20.454 9.60899C20.2401 9.5 19.9601 9.5 19.4 9.5L3 9.5L3 14.5L19.4 14.5Z"
        fill="currentColor"
      />
      <path
