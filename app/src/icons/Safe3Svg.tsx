export function Safe3Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        opacity="0.12"
        d="M9 13C10.3807 13 11.5 11.8807 11.5 10.5C11.5 9.11929 10.3807 8 9 8C7.61929 8 6.5 9.11929 6.5 10.5C6.5 11.8807 7.61929 13 9 13Z"
        fill="currentColor"
      />
      <path
