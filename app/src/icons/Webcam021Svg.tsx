export function Webcam021Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        opacity="0.12"
        d="M12 13.6875C13.7604 13.6875 15.1875 12.2604 15.1875 10.5C15.1875 8.73959 13.7604 7.3125 12 7.3125C10.2396 7.3125 8.8125 8.73959 8.8125 10.5C8.8125 12.2604 10.2396 13.6875 12 13.6875Z"
        fill="currentColor"
      />
      <path
