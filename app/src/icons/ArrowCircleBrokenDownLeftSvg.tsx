export function ArrowCircleBrokenDownLeftSvg({
  className,
}: {
  className?: string;
}) {
  return (
    ...
    >
      <path
        opacity="0.12"
        d="M4.92893 19.0711C8.83418 22.9763 15.1658 22.9763 19.0711 19.0711C21.6884 16.4538 22.5515 12.7466 21.6606 9.41045L14.5896 2.33938C11.2534 1.44846 7.54623 2.31164 4.92893 4.92893C1.02369 8.83418 1.02369 15.1658 4.92893 19.0711Z"
        fill="currentColor"
      />
      <path
