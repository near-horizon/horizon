export function BellPlus2Svg({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      />
      <path
        d="M9.35413 21C10.0593 21.6224 10.9855 22 12 22C13.0144 22 13.9406 21.6224 14.6458 21M18 8V2M15 5H21"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
