export function HorizontalBarChart031Svg({
  className,
}: {
  className?: string;
}) {
  return (
    ...
    >
      <path
        opacity="0.12"
        d="M19.4 19.5C19.9601 19.5 20.2401 19.5 20.454 19.391C20.6422 19.2951 20.7951 19.1422 20.891 18.954C21 18.7401 21 18.4601 21 17.9V16.1C21 15.5399 21 15.2599 20.891 15.046C20.7951 14.8578 20.6422 14.7049 20.454 14.609C20.2401 14.5 19.9601 14.5 19.4 14.5L3 14.5L3 19.5L19.4 19.5Z"
        fill="currentColor"
      />
      <path
